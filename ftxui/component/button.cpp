...
#include "component_options.hpp"  // for ButtonOption
...
#include "../dom/elements.hpp"  // for operator|, Element, nothing, reflect, text, border, inverted
#include "../screen/box.hpp"  // for Box
#include "../util/ref.hpp"    // for ConstStringRef, Ref
